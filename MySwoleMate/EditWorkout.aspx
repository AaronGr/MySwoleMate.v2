        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h1>EDIT EXISTING 5-STEP WORKOUT</h1>
                </div>
            </div>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-xs-2">
                        ...
                        <div class="has-error">
                            <span class="help-block">
                               <asp:RequiredFieldValidator ID="Exerecise2SetsRequired" runat="server" ErrorMessage="# of Exercise 2 sets is Required"
                    ...
                    <div class="col-xs-2">
                        ...
                        <div class="has-error">
                            <span class="help-block">
                                <asp:RequiredFieldValidator ID="Exercise2RepsRequired" runat="server" ErrorMessage="# of Exercise 2 reps is Required"
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-4 col-xs-offset-4">
                            ...
                            <a href="~/Workouts.aspx" runat="server" class="btn btn-default">Back</a>
                        </div>
                    </div>
                </div>
            </div>
