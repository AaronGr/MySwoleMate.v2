...
namespace MySwoleMate.BLL
{
    public class TraineeBLL
    {
        ...
        public bool HasWorkoutAssigned(int id)
        {
            return data.HasWorkoutAssigned(id);
        }
        ...
        //Assign a Workout by WorkoutID
        public int AssignWorkout(int traineeID, int workoutID)
        {
            return data.AssignWorkout(traineeID, workoutID);
        }
        ...
        private string PhoneDisplay(string number)
        {
            ...
            string middleNumbers = number.Substring(3, 3);
            string lastNumbers = number.Substring(6, 4);
